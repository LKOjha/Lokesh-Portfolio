    ...
    return (
        <section className="min-h-screen bg-[#050816] text-white py-1 px-6 md:px-20 relative z-0">
            ...
            >
                ...
                {/* Form Section */}
                {/* <div className="max-w-3xl mx-auto mb-20 mt-24 bg-[#100d25] p-8 rounded-2xl border border-white/5 shadow-xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 text-left">
                        <div className="flex flex-col">
                            ...
                            <input
                                ...
                                className="bg-[#1c1c3d] py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium"
                                value={formData.name}
                        ...
                        <div className="flex flex-col">
                            <label className="text-white font-medium mb-2">Phone Number</label>
                            <input
                                type="tel"
                                name="phone"
                        ...
                        <button
                            type="submit"
                            className="bg-yellow-400 py-3 px-8 outline-none w-fit text-black font-bold shadow-md shadow-primary rounded-xl hover:bg-yellow-300 transition-all"
                        >
                            Send Message
                        </button>
                    </form>
